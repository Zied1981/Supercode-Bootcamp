...
const Codinglife = () => {
  ...
  return (
    <section className="codinglife">
      <img src={blogData[5].img_url} alt="codinglife img" />
      <div className="codinglifediv">
        <h1>{blogData[5].title}</h1>
        <p>{blogData[5].published_date}</p>
      </div>
      <p>{blogData[5].description}</p>
      <h5>{blogData[5].author}</h5>
    </section>
  );
};
